  ...
  Future<Map> _getGiphys() async {
    ...
    if (_search == null || _search.isEmpty)
      response = await http.get(
          'https://api.giphy.com/v1/gifs/trending?api_key=5iRfyuBMqxSU1KZnSYdUs57V5CQiflGv&limit=20&rating=G');
    else
      response = await http.get(
          'https://api.giphy.com/v1/gifs/search?api_key=5iRfyuBMqxSU1KZnSYdUs57V5CQiflGv&q=$_search&limit=19&offset=$_offset&rating=G&lang=en');
